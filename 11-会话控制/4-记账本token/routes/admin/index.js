 ...
 */
// 首页
router.get('/', checkLoginMiddleware, function (req, resp, next) {
...
// 记账页面
router.get('/toCreate', checkLoginMiddleware, function (req, resp, next) {
  resp.render('create')
})
 ...
 */
// 记账
router.post('/create', checkLoginMiddleware, function (req, resp, next) {
...
// 删除
router.get('/delete/:id', checkLoginMiddleware, function (req, resp, next) {
